...
do
	...
	sed -i "s/vVERSION/v$i" optimization/CMS-HGG_mva_13TeV_datacard_v$i.txt
	cd optimization
	...
	ln -s /afs/cern.ch/work/x/xiaomeng/test/myWorkingArea/CMSSW_8_1_0/src/flashggFinalFit/Background/CMS-HGG_multipdf_leptonic_bdt_tuneV$i.root CMS-HGG_multipdf_leptonic_bdt_v$i.root
